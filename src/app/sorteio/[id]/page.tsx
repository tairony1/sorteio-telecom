...
// export default async function Sorteio({
//   params,
// }: {
...
export default function Sorteio({
  ...
  // -------------------------------------------
  // Gerar tickets somente no client (evita hydration mismatch)
  // -------------------------------------------
  useEffect(() => {
    setMockTickets(
                  ...
                  {['primeiro', 'segundo', 'terceiro'].map((pos, i) => (
                    <div className="space-y-2" key={pos}>
                      ...
                      <Input
                        ...
                        value={tempWinners[pos as keyof typeof tempWinners]}
                        maxLength={5}
                        onChange={(e) =>
                          setTempWinners({
                            ...tempWinners,
                      ...
                      >
                        <div className="flex flex-col gap-2">
                          <div className="flex justify-between">
                            ...
                            <Badge
                              variant={
                                ticket.resgatado ? 'default' : 'secondary'
                              }
                            >
              ...
              <Card className="border-dashed">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Os vencedores aparecerão aqui quando o sorteio for
                    concluído.
                  </p>
                </CardContent>
              </Card>
